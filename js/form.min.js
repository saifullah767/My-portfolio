    ...
    (e.fn.ajaxSubmit = function (t) {
      function r(t) {
        ...
        for (r = 0; i > r; r++)
          (n[r] = n[r].replace(/\+/g, " ")),
            (a = n[r].split("=")),
            o.push([decodeURIComponent(a[0]), decodeURIComponent(a[1])]);
        return o;
      }
      function o(a) {
      ...
      var k,
        D = (T || w) && !S;
      t.iframe !== !1 && (t.iframe || D)
        ? t.closeKeepAlive
          ? e.get(t.closeKeepAlive, function () {
              k = s(v);
            })
          : (k = s(v))
        : (k = (T || w) && S ? o(v) : e.ajax(t)),
        f.removeData("jqxhr").data("jqxhr", k);
      ...
      for (s = 0, m = o.length; m > s; s++)
        if (((f = o[s]), (l = f.name), l && !f.disabled))
          if (t && i.clk && "image" == f.type)
            ...
            for (r && r.push(f), u = 0, d = c.length; d > u; u++)
            ...
            if (p.length)
              for (u = 0; u < p.length; u++)
                a.push({ name: l, value: p[u], type: f.type });
